    ...
    var changeParams = (0, react_1.useCallback)(function (action) {
        if (!tempParams.current) {
            ...
            setTimeout(function () {
                if (syncWithLocation) {
                    history.push({
                        search: "?" + (0, query_string_1.stringify)(__assign(__assign({}, tempParams.current), { filter: JSON.stringify(tempParams.current.filter), displayedFilters: JSON.stringify(tempParams.current.displayedFilters) })),
