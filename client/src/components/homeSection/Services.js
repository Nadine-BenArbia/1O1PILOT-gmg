      ...
      <ServicesContainer id="services">
        ...
        <ServicesWrapper>
          <ServicesCard>
            ...
            <ServicesP>
              {" "}
              List your required skills for the job so the right candidates
              apply
            </ServicesP>
          </ServicesCard>
          <ServicesCard>
            ...
            <ServicesP>
              {" "}
              view and sort resumes,send messages,and schedule interviews
            </ServicesP>
          </ServicesCard>
          <ServicesCard>
            ...
            <ServicesP>
              {" "}
              Get better visibility when you pay to post your job{" "}
            </ServicesP>
          </ServicesCard>
        </ServicesWrapper>
      </ServicesContainer>
